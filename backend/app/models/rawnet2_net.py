"""
RawNet2 network definition (Eurecom / Jung et al., Interspeech 2020).

Vendored from ALLA1N/rawnet2-la-clean-specialist `model.py` (MIT) with
training/eval helpers removed — inference graph only. Module and attribute
names are kept EXACT so `best_model.pth` (`model_state_dict`) loads with
zero missing keys.
"""
import numpy as np
import torch
